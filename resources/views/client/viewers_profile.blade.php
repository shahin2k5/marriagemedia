...
<li><a href="{{route('client.showViewersList')}}">View Profiles</a></li>
...
<span class="pull-right">
 <a href="{{route('client.showViewersList')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
