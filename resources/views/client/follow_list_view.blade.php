...
<li><a href="{{route('client.showFollowList')}}">Follow List</a></li>
...
<h3 class="box-title">Follow Profile</h3>
<span class="pull-right">
 <a href="{{route('client.showFollowList')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
