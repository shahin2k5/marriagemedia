...
<h3 class="box-title">Client Preference</h3>
<span class="pull-right">
  <a href="{{route('client.showPreference')}}" class="btn btn-warning btn-sm">
    <i class="fa fa-refresh fa-fw"></i>
  </a>
</span>
</div><!-- /.box-header -->
<!-- form start -->
<form action="{{route('client.insertPreference')}}" method="post">
  {!! csrf_field() !!}
<div class="box-body">
<div class="row">
