...
<li><a href="{{route('client.showSendProposals')}}">Send All Proposals</a></li>
...
<span class="pull-right">
 <a href="{{route('client.showSendProposals')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
