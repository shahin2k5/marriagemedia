...
<ol class="breadcrumb">
<li><a href="{{route('client.dashboard')}}"><i class="fa fa-list"></i> Suggestion List</a></li>
...
<span class="pull-right">
 <a href="{{route('client.dashboard')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
