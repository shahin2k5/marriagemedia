...
<h3 class="box-title">Viewers List ({{$viewersCounts}})</h3>
<span class="pull-right">
<a href="{{route('client.showViewersList')}}" class="btn btn-success btn-sm" data-toggle = "title" title = "Refresh">
...
<td style="vertical-align: middle;">
  <a href="{{route('client.showViewersProfile', $fl->Profile->id)}}"><i class="fa fa-eye fa-lg" style="color:green;"></i></a>
</td>
</tr>
<?php $i++; ?>
@endforeach
