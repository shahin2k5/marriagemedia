...
<li><a href="{{route('client.showProposals')}}">All Proposals</a></li>
...
<h3 class="box-title">Proposal Profile</h3>
<span class="pull-right">
 <a href="{{route('client.showProposals')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
...
@if(!empty($assignPackage))
    @if(empty($proposalList))
      <a href="{{route('client.acceptProposals', $profileInfo->id)}}" class="btn btn-info btn-block">Accept Proposal</a>
    @else
      <a class="btn btn-default btn-block">Proposal Accepted</a>
    @endif
