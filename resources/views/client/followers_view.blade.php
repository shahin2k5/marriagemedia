...
<li><a href="{{route('client.showFollowers')}}">All Followers</a></li>
...
<h3 class="box-title">Follower Profile</h3>
<span class="pull-right">
 <a href="{{route('client.showFollowers')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
