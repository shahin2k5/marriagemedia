...
<li><a href="{{route('agent.showAgentUnpaidUsers')}}">Agent unpaid users</a></li>
...
<span class="pull-right">
  <a href="{{route('agent.agentViewThis', $profileInfo->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i></a>
  <a href="{{route('agent.showAgentUnpaidUsers')}}" class="btn btn-success btn-sm"><i class="fa fa-reply"></i></a>
...
<form action="{{route('agent.insertAssignForAgent')}}" method="post">
  {!! csrf_field() !!}
