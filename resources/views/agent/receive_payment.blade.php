...
<a href="{{route('admin.showReceivePayment')}}" class="btn btn-success btn-sm" data-toggle = "title" title = "Refresh">
...
<a href="{{route('agent.verifyPaymentForAgent', $pi->id)}}" class="btn btn-warning btn-sm">Verify</a>
@else
