...
<li><a href = "{{route('agent.showAgentAllUsers')}}">All Users</a></li>
...
<a href="{{route('agent.showAgentAllUsers')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply"></i></a>	
<a href="{{route('agent.agentNewProfile')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
...
<form  action="{{route('agent.createNewProfile')}}" method="post">
  {!! csrf_field() !!}
<div class="row">
<div class="col-md-6">
