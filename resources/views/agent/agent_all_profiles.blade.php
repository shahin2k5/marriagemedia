...
<li><a href = "{{route('agent.showAgentAllUsers')}}">Agent All Users</a></li>
<li class="active">Agent Edit / Update Profile</li>
</ol>
<br/>
<div class="row">
<div class="col-md-12">
...
<h3 class="box-title">Agent All Profile Edit / Update</h3>
<a href="{{route('agent.showAgentAllProfile', $profileInfo->id)}}" class="btn btn-danger btn-sm pull-right"><i class="fa fa-refresh"></i></a>
<a href="{{route('agent.showAgentAllUsers')}}" class="btn btn-warning btn-sm pull-right"><i class="fa fa-reply"></i></a>
</div><!-- /.box-header -->
...
<form action="{{route('agent.createFamilyForAgent', $profileInfo->id)}}" method="post">
  {!! csrf_field() !!}
<div class="row">
...
<form action="{{route('agent.createOccupationForAgent', $profileInfo->id)}}" method="post">
  {!! csrf_field() !!}
...
<form action="{{route('agent.createAboutForAgent', $profileInfo->id)}}" method="post">
  {!! csrf_field() !!}
