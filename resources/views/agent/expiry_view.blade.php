...
<li>
<a href="{{route('agent.showExpiryUsers')}}">All Expiry View</a></li>
...
<span class="pull-right">
	<a href="{{route('agent.showExpiryUsers')}}" class="btn btn-success btn-sm"><i class="fa fa-reply fa-fw"></i></a>
	<a href="{{route('agent.showExpiryView',$profileInfo->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-refresh fa-fw"></i></a>
</span>
</div><!-- /.box-header -->
...
<form action="{{route('agent.insertExpiryPayment')}}" method="post">
  {!! csrf_field() !!}
...
<div class="form-group">
<button class="btn btn-info btn-block" type="button" data-toggle="modal" data-target="#myModal" >Unpdate</button>
</div>
