...
<form action="{{route('agent.updatePackagesByAgent', $package->id)}}" method="post">
	{!! csrf_field() !!}
...
<a href="{{route('agent.editPackageByAgent', $package->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
