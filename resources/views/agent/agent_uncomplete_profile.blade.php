...
<li><a href = "{{route('agent.showAgentUncompleteUsers')}}">Agent Uncomplete Users</a></li>
...
<h3 class="box-title">Agent Uncomplete Profile Edit / Update</h3>
<span class="pull-right">
<a href="{{route('agent.showAgentUncompleteProfile', $profileInfo->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
</div><!-- /.box-header -->
