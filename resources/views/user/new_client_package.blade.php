...
<form action="{{route('user.insertClientPackage')}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('user.showNewClPackage')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
