...
<form action="{{route('user.insertNewLinks')}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('user.showNewLinks')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
