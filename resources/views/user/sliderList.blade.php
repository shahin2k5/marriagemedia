...
<li><a href="{{route('user.showSliderImage')}}">Slider</a></li>
...
<span class="pull-right">
  <a href="{{route('user.showSliderImage')}}" class="btn btn-warning btn-sm">
...
@foreach($sliderImages as $si)
      ...
      <a href="{{route('user.deleteSliderImage', $si->id)}}" style="color: red;"><i class="fa fa-trash fa-fw"></i></a>  
      </td>
  	</tr>
  <?php $i++; ?>
@endforeach
