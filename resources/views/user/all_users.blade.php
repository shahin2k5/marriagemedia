...
<a href="{{route('user.showAllUsers')}}" class="btn btn-primary btn-sm"><i class="fa fa-refresh"></i></a>

<a href="{{route('user.showNewProfile')}}" class="btn btn-success btn-sm" data-toggle = "title" title = "Add New Client">
...
<div class="container-fluid">
  <div class="well" style="font-size:12px;">
    ...
    <form action="{{route('user.allsearch')}}" method="post">
      {!! csrf_field() !!}
      <div class="row">
        <div class="col-md-2">
...
<a href="{{route('user.changeActiveStatus', $pl->id)}}" class="btn btn-warning btn-sm">Deactive</a>
@else
<a href="{{route('user.changeActiveStatus', $pl->id)}}" class="btn btn-success btn-sm">Active</a>
@endif
</td>
<td>
  <!-- <a href="{{route('user.showPersonalInfoForuser', $pl->id)}}"><i class="fa fa-edit fa-lg" style="color:green;"></i></a> || 
  <a href="{{route('user.deleteProfile', $pl->id)}}"><i class="fa fa-trash fa-lg" style="color:orange;"></i></a> -->
  <a href="{{route('user.showAllUsersViewById', $pl->id)}}" class="btn btn-primary btn-sm">Details</a>
</td>
</tr>
<?php $i++; ?>
@endforeach
