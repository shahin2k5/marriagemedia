...
<ol class="breadcrumb">
<li><a href="{{route('user.showAllUsers')}}"><i class="fa fa-graduation-cap"></i> All Clients</a></li>
...
<a href="{{route('user.showAllUsers')}}" class="btn btn-success btn-sm pull-right"><i class="fa fa-reply"></i></a>
</div><!-- /.box-header -->
...
<a href="{{route('user.showProfileForEdit', $profileInfo->id)}}" class="btn btn-primary btn-block"><i class="fa fa-edit"></i> Edit</a>
@if($profileInfo->Emails->active==1)
<a href="{{route('user.changeActiveStatus', $profileInfo->id)}}" class="btn btn-warning btn-block"><i class="fa fa-ban"></i> Deactive</a>
@else
<a href="{{route('user.changeActiveStatus', $profileInfo->id)}}" class="btn btn-success btn-block"><i class="fa fa-ok"></i> Active</a>
@endif
