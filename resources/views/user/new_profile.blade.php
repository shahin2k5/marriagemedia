...
<a href="{{route('user.showAllUsers')}}" class="btn btn-warning btn-sm"><i class="fa fa-reply"></i></a>	
<a href="{{route('user.showNewProfile')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
...
<form  action="{{route('user.insertNewProfile')}}" method="post">
  {!! csrf_field() !!}
<div class="row">
<div class="col-md-6">
