...
<form action="{{route('user.updatePackages', $package->id)}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('user.editPackageBy', $package->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
