...
<form action="{{route('admin.insertNewPost')}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('admin.showNewPost')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
