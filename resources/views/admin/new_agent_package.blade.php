...
<form action="{{route('admin.insertAgentPackage')}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('admin.showNewAgentPackage')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
