...
<li class="active">Edit Assign Package</li>
</ol>
<br/>
...
<h3 class="box-title">Edit Assign Package</h3>
<span class="pull-right">
  <a href="{{route('admin.showPaidUsers')}}" class="btn btn-warning btn-sm">
...
@endif
<form action="{{route('admin.updateAssignPackage', $assignPackage->id)}}" method="post">
	{!! csrf_field() !!}
...
<select class="form-control" name="optPackageName" id="optPackageName" urlPac = "{{route('admin.showPackInfoBy')}}">
	<option value="{{$assignPackage->id}}">{{$assignPackage->Package->name}}</option>
...
<input type="text" name="txtValidityDays" id="txtValidityDays" value="{{$assignPackage->Package->validity_days}}" class="form-control" readonly />
</div>

<div class="form-group">
<label>Price</label>
<input type="number" name="txtPrice" id="txtPrice" class="form-control" value="{{$assignPackage->Package->price}}" readonly />
</div>

<div class="form-group">
<label>Expire Date</label>
<input type="date" name="dtExpireDate" id="dtExpireDate" class="form-control" value="{{$assignPackage->expire_date}}"  required />
</div>
