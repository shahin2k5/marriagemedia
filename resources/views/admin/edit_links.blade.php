...
<li><a href="{{route('admin.showAllLinks')}}">All Links</a></li>
...
<form action="{{route('admin.updateNewLinks', $linkInfo->id)}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('admin.editLinks', $linkInfo->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
