...
<form action="{{route('admin.updateAgent', $agentList->id)}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('admin.editAgent', $agentList->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
