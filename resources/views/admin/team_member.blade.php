...
<!-- form start -->
<form action="{{route('admin.insertTeamMember')}}" method="post" enctype="multipart/form-data">
  {!! csrf_field() !!}
<div class="box-body">
	...
	@foreach($teamMember as $tm)
		<tr>
			...
			<td style="vertical-align: middle;">
				<a href="{{route('admin.deleteTeamMember', $tm->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i></a>
				<a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-edit"></i></a>

	<form action="{{route('admin.updateTeamMember', $tm->id)}}" method="post" enctype="multipart/form-data">
		{!! csrf_field() !!}
			<!-- Modal -->
