...
<a href="{{route('admin.showProfileForEdit', $profileInfo->id)}}" class="btn btn-danger btn-sm pull-right"><i class="fa fa-refresh"></i></a>
<a href="{{route('admin.showAllUsers')}}" class="btn btn-warning btn-sm pull-right"><i class="fa fa-reply"></i></a>
</div><!-- /.box-header -->
...
<form  action="{{route('admin.createPersonalForAdmin', $profileInfo->id)}}" method="post">
  {!! csrf_field() !!}
<div class="row">
<div class="col-md-6">
