...
<form action="{{route('admin.insertNewAgent')}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('admin.showNewAgent')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
