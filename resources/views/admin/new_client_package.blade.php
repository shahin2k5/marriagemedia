...
<form action="{{route('admin.insertClientPackage')}}" method="post" enctype="multipart/form-data">
	{!! csrf_field() !!}
...
<a href="{{route('admin.showNewClPackage')}}" class="btn btn-danger btn-sm"><i class="fa fa-refresh"></i></a>
</span>
