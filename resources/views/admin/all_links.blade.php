...
<a href="{{route('admin.showNewLinks')}}" class="btn btn-success btn-sm" data-toggle = "title" title = "Add New Links">
...
<td style="vertical-align: middle;">
  <a href="{{route('admin.deleteLink', $al->id)}}"><i class="fa fa-trash fa-lg" style="color:orange;"></i></a>
  <a href="{{route('admin.editLinks', $al->id)}}"><i class="fa fa-edit fa-lg" style="color:green;"></i></a>
</td>
</tr>
<?php $i++; ?>
@endforeach
