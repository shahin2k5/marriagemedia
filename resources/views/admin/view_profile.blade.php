...
<li><a href = "{{route('admin.showUnpublishedUsers')}}">Users Unpublished List</a></li>
@else
<li><a href = "{{route('admin.showPublishedUsers')}}">Users Published List</a></li>
@endif
...
@if($profileInfo->publish_status=="Unpublished")
<a href="{{route('admin.changePublishStatus', $profileInfo->id)}}" class="btn btn-success btn-block">Publish</a>
@else
<a href="{{route('admin.changePublishStatus', $profileInfo->id)}}" class="btn btn-warning btn-block">Unpublish</a>
@endif
</div>
<div class="col-md-8">
