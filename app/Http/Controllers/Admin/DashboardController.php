...
class DashboardController extends Controller
{
    ...
    public function createCompanyInfo(Request $request){
        ...
        if($company_info_check!="" && $filename!=""):
        ...
        elseif($company_info_check=="" && $filename!=""):
    ...
    public function showUnpaidUsers(){
      ...
      return view('admin.users_unpaid',[
        'profileList'=>$profile_list,
        'profileCount'=>$profile_count
      ]);
    }
    ...
    public function showUncompleteUsers(){
      ...
      return view('admin.users_uncomplete',[
        'profileList'=>$profile_list,
        'profileCount'=>$profile_count
      ]);
    }
    ...
    public function showPublishedUsers(){
      ...
      return view('admin.users_published',[
        'profileList'=>$profile_list,
        'profileCount'=>$profile_count
      ]);
    }
    ...
    public function showUnpublishedUsers(){
      ...
      return view('admin.users_unpublished',[
        'profileList'=>$profile_list,
        'profileCount'=>$profile_count
      ]);
    }
    ...
    public function showProfileForEdit($id){
      ...
      return view('admin.profiles.personal_information',[
        'profileInfo'=>$profile_info,
    ...
    public function showFamilyInformation($id){
      $profile_info = ProfileList::where('id', $id)->first();
      $country_list = CountryLists::get();
      return view('admin.profiles.family_information',[
        'profileInfo'=>$profile_info,
        'countryList'=>$country_list,
        'id'=>$id
      ]);
    ...
    public function showOccupation($id){
      $profile_info = ProfileList::where('id', $id)->first();
      $country_list = CountryLists::get();
      return view('admin.profiles.occupation',[
        'profileInfo'=>$profile_info,
        'countryList'=>$country_list,
        'id'=>$id
      ]);
    ...
    public function showAbout($id){
      $profile_info = ProfileList::where('id', $id)->first();
      $country_list = CountryLists::get();
      return view('admin.profiles.about',[
        'profileInfo'=>$profile_info,
        'countryList'=>$country_list,
        'id'=>$id
      ]);
    ...
    public function showPreferences($id){
      $profile_info = ProfileList::where('id', $id)->first();
      $country_list = CountryLists::get();
      return view('admin.profiles.preference',[
        'profileInfo'=>$profile_info,
        'countryList'=>$country_list,
        'id'=>$id
      ]);
    ...
    public function showFinish($id){
      $profile_info = ProfileList::where('id', $id)->first();
      $country_list = CountryLists::get();
      return view('admin.profiles.finish',[
        'profileInfo'=>$profile_info,
        'countryList'=>$country_list,
        'id'=>$id
      ]);
    ...
    public function insertNewProfile(Request $request){
      ...
      // $profile_info = ProfileList::where('id', $profile->id)->first();
      $country_list = CountryLists::get();
      return redirect()->route('admin.showProfileForEdit',$profile->id);
    ...
    public function showNewClPackage(){
      return view('admin.new_client_package');
    }
    ...
    public function editPackageBy($id){
      ...
      return view('admin.edit_client_package',[
        'package'=>$package
      ]);
    }
    ...
    public function showAgentPackages(){
      ...
      return view('admin.agent_packages',[
    ...
    public function showNewAgentPackage(){
      return view('admin.new_agent_package');
    }
    ...
    public function assignPackageForClient($id){
      ...
      $profile_info = ProfileList::where('id', $id)->first();
      return view('admin.assign_package',[
        'packages'=>$packages,
        'profileInfo'=>$profile_info
      ]);
    }
    ...
    public function editAssignPackage($id){
      ...
      return view('admin.edit_assign_package',[
        'profileInfo'=>$profile_info,
        'packages'=>$packages,
    ...
    public function showUnpaidAgent(){
      ...
      return view('admin.unpaid_agent',[
    ...
    public function editAgentView($id){
      ...
      $packages = Packages::where('package_for', 'Agent')->get();
      return view('admin.edit_agent_view',[
    ...
    public function showAgentExpInfo(){
      ...
      return view('admin.agent_expire_info',[
    ...
    public function editUsersList($id){
      ...
      return view('admin.edit_new_users',[
        'userList'=>$user_list
      ]);
    }
    ...
    public function showReceivePayment(){
      ...
      $packages = Packages::where('package_for', 'Client')->get();
      return view('admin.receive_payment',[
    ...
    public function showAllUsersViewById($id){
      ...
      $packages = Packages::where('package_for', 'Client')->get();
      return view('admin.all_users_view',[
        'profileInfo'=>$profile_info,
        'completePercent'=>$complete_percent,
        'packages'=>$packages
      ]);
    ...
    public function receivePayment(Request $request, $id){
        ...
        $profile = ProfileList::where('id', $id)->first();
    ...
    public function getDataByPackageId(Request $request){
    ...
    public function showMessage(){
      $all_message = AdminMessage::groupBy('profile_id')->get();
      return view('admin.message', compact('all_message'));
    }
    ...
    public function showReplyMessage($id){
      ...
      $message_views = AdminMessage::where('id', $id)->first();

      $profile = ProfileList::where('id', $message_views->profile_id)->first();
    
      $sender = AdminMessage::where([
        'added_by'=>Auth::user()->id
      ])->get();

      $receiver = AdminMessage::where([
        'profile_id'=>$message_views->profile_id,
        'title'=>'Reply Message'
      ])->get();
